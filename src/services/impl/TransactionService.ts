...
import { Transactions, TransactionCreateRequest, Transaction, TransactionSchema } from "../../domain/transactionSchema";
...
export class TransactionService implements ITransactionService {
    ...
    async getMyTransactions(userId: string): Promise<ServiceResult<Transactions>> {
        try {
            ...
            return {
                data: transactions.map((transaction) => TransactionSchema.parse(transaction)),
                statusCode: 200
            }
        } catch (error: any) {
            return {
